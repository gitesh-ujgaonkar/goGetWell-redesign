...
export default function Header() {
  ...
  return (
    <>
<header className="sticky top-0 z-50 w-full border-b bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:bg-gray-900/95 dark:border-gray-800">
