        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          ...
          >
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-gray-500 dark:text-gray-400 md:text-xl lg:text-2xl">
          ...
          >
            <div className="relative w-full max-w-[600px] aspect-square md:aspect-video overflow-hidden rounded-xl shadow-xl">
              <Image
              ...
              <motion.div
                className="absolute top-1/4 right-1/4 bg-white dark:bg-gray-800 p-3 rounded-lg shadow-lg"
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium">Patient Inquiries +200%</span>
                </div>
              </motion.div>

              <motion.div
                className="absolute bottom-1/4 left-1/4 bg-white dark:bg-gray-800 p-3 rounded-lg shadow-lg"
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
